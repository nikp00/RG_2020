...
export const availableVehicles = {
	formula: {
		name: "Formula",
		thumbnail: "../../models/vehicle/formula/thumbnail.jpg",
		url: "../../models/vehicle/formula/formula.gltf",
		stats: {
			maxSpeed: 80,
	...
	police: {
		thumbnail: "../../models/vehicle/police/thumbnail.jpg",
		url: "../../models/vehicle/police/police.gltf",
		name: "Police",
		stats: {
			maxSpeed: 50,
			maxEngineForce: 5000,
